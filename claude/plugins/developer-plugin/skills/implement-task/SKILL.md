...
4. If required TASK_SPEC or DESIGN_SPEC fields are missing or contradictory, report the blocker before implementation.
5. Implement the smallest safe change inside scope.
6. Add or update tests according to the TASK_SPEC.
7. Run targeted checks first, then broader lint/typecheck/test commands when available.
8. Report changed files, verification evidence, screenshots or visual evidence when relevant, and residual risk.
